...
(function() {
  ...
  isStandaloneAndTTY = /docpad$/.test(process.argv[1] || '') && docpadUtil.isTTY();
  ...
  DocPad = (function(superClass) {
    ...
    DocPad.prototype.getSkeletons = function(next) {
      ...
      this.getExchange(function(err, exchange) {
        var index, ref1, skeleton, skeletonKey;
        if (err) {
          return next(err);
        }
        index = 0;
        if (exchange) {
          ref1 = exchange.skeletons;
          for (skeletonKey in ref1) {
            if (!hasProp.call(ref1, skeletonKey)) continue;
            skeleton = ref1[skeletonKey];
            if (skeleton.id == null) {
    ...
    DocPad.prototype.updateUserConfig = function(data, next) {
      var docpad, ref1, userConfigPath, userConfigString;
      if (data == null) {
        data = {};
      }
      ...
      userConfigString = CSON.stringify(this.userConfig);
      if (userConfigString instanceof Error) {
        return typeof next === "function" ? next(err) : void 0;
      }
      safefs.writeFile(userConfigPath, userConfigString, 'utf8', function(err) {
        return typeof next === "function" ? next(err) : void 0;
      });
      return this;
    };
    ...
    DocPad.prototype.loadConfigUrl = function(configUrl, next) {
      ...
      superAgent.get(configUrl).timeout(30 * 1000).end(function(err, res) {
        ...
        result = CSON.parse(res.text, {
          filename: configUrl.replace(/\?.*/, '')
        });
        if (result instanceof Error) {
          return typeof next === "function" ? next(result) : void 0;
        }
